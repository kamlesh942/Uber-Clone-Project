...
const Home = () => {
  ...
  return (
    <div>
      <div className='bg-[url(https://images.unsplash.com/photo-1518430272387-254558840136?q=80&w=1063&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover h-screen pt-9 flex flex-col justify-between w-full bg-red-400'>
